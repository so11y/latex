    ...
    <NNotificationProvider>
      <NMessageProvider>
        <StoreContain v-slot="handleStore">
          ...
          >
          <NButton
            @click="handleStore.putActiveChildren('Bracket', '括号', 'Bracket')"
            >Bracket</NButton
          >
          ...
          <div>
            ...
            <NButton
              @click="
                handleStore.putActiveChildren('Gt', '>', 'Logical', {
                  operator: '>',
                })
              "
              >Gt</NButton
            ...
            <NButton
              @click="
                handleStore.putActiveChildren('Lt', '<', 'Logical', {
                  operator: '<',
                })
              "
              >Lt</NButton
            ...
            <NButton
              @click="
                handleStore.putActiveChildren('EGt', '>=', 'Logical', {
                  operator: '\\ge',
                })
              "
              >EGt</NButton
            ...
            <NButton
              @click="
                handleStore.putActiveChildren('ELt', '<=', 'Logical', {
                  operator: '\\le',
                })
              "
              >ELt</NButton
